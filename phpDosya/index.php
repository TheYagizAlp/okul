        ...
        <div class="row">
            <div class="col-md-4">
                ...
                <form action="index.php"  method="post" enctype="multipart/form-data">
                    ...
                    <input type="submit" value="Register"  class="form-control btn btn-success btn-md">
                </form>
            </div>
            <div class="col-md-8">
                <h2>Users</h2><hr>
                ...
                <table width="100%" class="text-center">
                    <tr>
                        <td>
                            <img src="upload/<?= $u['pfp']?>" style="border-radius:500px" width="100" height="100" alt="pfp">
                            <form action="pfpUpdate.php" method="post" enctype="multipart/form-data">
                                <input type="hidden" name="userId" value="<?= $u['userId']?>"><br>
                                <input type="file" name="new_pfp" class="form-control"><br>
                                <input type="submit" value="Edit Profile Picture" name="pfpUpdate" class="btn btn-info btn-sm form-control"><br><br>
                            </form>
                        </td>
                        <td><?= $u['username']; ?></td>
                        <td><?= $u['email']; ?></td>
                        <td><?= $u['country']; ?></td>
                        <td>
                            <form action="sil.php" method="post" enctype="multipart/form-data">
